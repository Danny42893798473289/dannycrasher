package me.dannycrasher.client.chat;
...
public final class ChatHelper {
	private static final String CLIENT_PREFIX = "<dark_gray>[<gradient:#4facfe:#00f2fe>Danny Crasher</gradient><dark_gray>]</dark_gray> <reset>";
