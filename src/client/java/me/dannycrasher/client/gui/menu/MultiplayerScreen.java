...
import me.dannycrasher.client.utils.ServerPingUtil;
import me.dannycrasher.client.utils.ServerPingUtil.PingResult;
...
public class MultiplayerScreen extends Screen {
    ...
    public MultiplayerScreen(Screen parent, boolean ignoreInitialClick) {
        super(Component.literal("Danny Crasher Multiplayer"));
        this.parent = parent;
    ...
    private ResourceLocation getServerIcon(ServerData server) {
        ...
        try {
            ...
            ResourceLocation location = ResourceLocation.fromNamespaceAndPath("dannycrasher", "server_icons/" + Integer.toHexString(key.hashCode()));
