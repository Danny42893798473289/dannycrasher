...
public class MainMenuScreen extends Screen {
	...
	public MainMenuScreen() {
		super(Component.literal("Danny Crasher"));
	}
	...
	private void renderBrand(GuiGraphics graphics) {
		...
		graphics.drawString(font, "Danny Crasher", x + 22, y + 24, MenuTheme.TEXT, true);
		graphics.drawString(font, "Version " + DannyCrasher.VERSION + " / Minecraft 1.21.4", x + 22, y + 40, MenuTheme.SOFT_TEXT, true);
		graphics.drawString(font, "Authorized server security testing toolkit", x + 22, y + 58, MenuTheme.MUTED_TEXT, true);
	}
	...
	private void renderFooter(GuiGraphics graphics) {
		String footer = "Danny Crasher | Created by danny";
