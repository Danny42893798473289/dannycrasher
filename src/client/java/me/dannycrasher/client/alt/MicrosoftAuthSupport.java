package me.dannycrasher.client.alt;
...
public final class MicrosoftAuthSupport {
	...
	private static final ExecutorService EXECUTOR = Executors.newSingleThreadExecutor(runnable -> {
		Thread thread = new Thread(runnable, "DannyCrasher-MicrosoftAuth");
		thread.setDaemon(true);
		return thread;
	});

	static {
		MinecraftAuth.USER_AGENT = "DannyCrasher/" + DannyCrasher.VERSION;
