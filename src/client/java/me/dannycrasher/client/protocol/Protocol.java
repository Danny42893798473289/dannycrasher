package me.dannycrasher.client.protocol;
...
public class Protocol {
    ...
    /** Protocols that accept full ItemStack payloads in container clicks. */
    public static final List<Integer> FULL_ITEM_PROTOCOLS = List.of(766, 767, 768, 769);
    /** Protocols that use hashed ItemStack payloads in container clicks (1.21.5+). */
    public static final List<Integer> HASHED_ITEM_PROTOCOLS = List.of(770);
    public static final List<Integer> SUPPORTED_PROTOCOLS = List.of(766, 767, 768, 769, 770);
